...
#SBATCH --nodes=2
#SBATCH -o logs/GPU_Cannabis_FAQ02599.sh-%j.out
#SBATCH -e logs/GPU_Cannabis_FAQ02599-%j.err
...
Folder_Origen="Cannabis_RNA_Kalea_MOC20P01/Kalea_YL_ML_Stem_SAPX_Roots_fembuds/20210527_1902_MN25889_FAQ02599_0eff6335/fast5"
Folder_Destino="FAQ02599/MOC20P01/basecall"
