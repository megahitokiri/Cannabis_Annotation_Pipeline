...
#SBATCH --nodes=2
#SBATCH -o logs/GPU_Cannabis_FAQ04635-%j.out
#SBATCH -e logs/GPU_Cannabis_FAQ04635-%j.err
...
Folder_Origen="/home/jmlazaro/scratch/Cannabis2/Cannabis_RNA_Luminarium_MOT19P01/Luminarium_MOT19P01_combined"
Folder_Destino="FAQ04635/MOT19P01/basecall"
